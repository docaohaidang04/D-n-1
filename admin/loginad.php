...
<br>
<div class="form_lo" style="height: 450px;">
    <img src=" ../layout/img/logo1.jpg" alt="" style="width: 150px; border-radius: 25px;">
    <p class="dk">ĐĂNG NHẬP</p>
    <img src="" alt="">
    <form action="admin.php?pg=login" method="post" onsubmit="return validateForm()">
        <div class="form_full">
            <div>
            ...
            <div class="fo1">
                ...
                <div class="password-field">
                    <input type="password" id="password" name="password" placeholder="Nhập mật khẩu"
                        style="background-image:url('layout/img/eye-off-icon.png');">
